        ...
        <div v-for="(item, index) in itemList" :key="index" class="card"
          ...
          <div class="card__content">
            <div class="card__input-row">
              <label class="card__label">接收人:</label>
              <input type="text" v-model="item.employeeName" placeholder="请输入接收人" class="card__input card__input--employee"
                @input="handleEmployeeNameInput(item, $event.target.value)" />
            </div>
            <div class="card__input-row">
