  ...
  <div>
    <div class="container">
      ...
      <div class="field-container">
        ...
        <van-field v-model="data.PassBQty" label="接收数量" required clearable v-long-press-tooltip="data.PassBQty" />
      </div>
      <van-field v-model="data.MaterialSpecType" label="规格型号" readonly v-long-press-tooltip="data.MaterialSpecType" />
      <van-field v-model="data.MaterialSpecTypeExplain" label="规格型号说明" readonly v-long-press-tooltip="data.MaterialSpecTypeExplain" />
      ...
      <div class="field-container">
        ...
        <van-field v-model="data.ReceiveEmployeeName" label="计件人员" required clearable v-long-press-tooltip="data.ReceiveEmployeeName" />
      </div>
