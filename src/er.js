...
import ViewportDemo from './views/demo/ViewportDemo.vue'
import BillPageTemplateDemo from './views/demo/BillPageTemplateDemo.vue'
import DeviceDetectionTest from './views/demo/DeviceDetectionTest.vue'
import AndroidBridgeDemo from './views/demo/AndroidBridgeDemo.vue'
import ScanCodeDemo from './views/demo/ScanCodeDemo.vue'
...
import LogoutPage from './views/logout/Logout.vue'
...
const routes = [
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { path: 'android-bridge-demo', component: AndroidBridgeDemo, meta: { requiresAuth: true } },
                    { path: 'scan-code-demo', component: ScanCodeDemo, meta: { requiresAuth: true } },
                ]
            },
    ...
    { path: '/android-bridge-demo', component: AndroidBridgeDemo },
]
